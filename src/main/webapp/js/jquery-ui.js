...
$.extend(Datepicker.prototype, {
	...
	_showDatepicker: function(input) {
		...
		// window.pickerTop = offset.top - parseInt($("#" + inst.id).parents(".mCSB_container").css("top")); //freesos

		if (!inst.inline) {
			showAnim = $.datepicker._get(inst, "showAnim");
			duration = $.datepicker._get(inst, "duration");
			//inst.dpDiv.css( "z-index", datepicker_getZindex( $( input ) ) + 1 );
			inst.dpDiv.css( "z-index", 750 );
	...
	_updateDatepicker: function(inst) {
		...
		// $("select", inst.dpDiv).selectbox(); //freesos
	...
	_generateHTML: function(inst) {
		...
		for (row = 0; row < numMonths[0]; row++) {
			...
			for (col = 0; col < numMonths[1]; col++) {
				...
				//freesos
				calender += this._generateMonthYearBottom(inst, drawMonth, drawYear, minDate, maxDate,
	...
	/* Generate the month and year bottom. */ //freesos
	_generateMonthYearBottom: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		var inMinYear, inMaxYear, month, years, thisYear, determineYear, year, endYear,
			...
			html = "<div class='ui-datepicker-bottom'>",
			monthHtml = "";
	...
	_generateMonthYearHeader: function(inst, drawMonth, drawYear, minDate, maxDate,
		...
		if (secondary || !changeMonth) {
			...
			var mm = parseInt(monthNames[drawMonth]) - 1;
			monthHtml += "<span class='ui-datepicker-month'>" + monthNames[drawMonth] + "</span>" + arry[mm];
		}
