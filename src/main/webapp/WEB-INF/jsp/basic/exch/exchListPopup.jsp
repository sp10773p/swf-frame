<%--
    Class Name : exchListPopup.jsp
    Description : 환율 조회
    Modification Information
    수정일 수정자 수정내용
    ----------- -------- ---------------------------
    2017-03-21  정안균   최초 생성
    ...
    <div class="layer_content">
	    	...
	    	<div class="search_toggle_frame">
		        <div class="search_frame on">
		            <ul class="search_sectionC">
		                <li>
	                        <label for="F_APPLY_DATE" class="search_title">기준일자</label>
	                        <label for="T_APPLY_DATE" class="search_title" style="display: none">기준일자</label>
	                    ...
	                    <li>
	                        <label for="NATION" class="search_title">국가코드</label>
	                        <input id="NATION" name="NATION" class="search_input" style="width:calc(100% - 300px)"/>
	                    </li>
		            </ul>
			        <!-- search_sectionC -->
	    ...
	    <div class="vertical_frame">
		        ...
		        <div class="vertical_frame_left55">
		            <div class="title_frame"  style="margin-bottom: 0px;">
		            ...
		            <div class="white_frame">
		                ...
		                <div id="gridLayer" style="overflow: auto; height: 435px">
		                </div>
		        ...
		        <div class="vertical_frame_right55">
		            ...
		            <div class="white_frame">
		                ...
		                <div id="gridLayer2" style="overflow: auto; height: 435px">
		                </div>
		                <div class="bottom_util">
