...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            gridWrapper = new GridWrapper({
                ...
                "controllers": [
                    ...
                    {"btnName": "btnDel"   , "type": "D", "targetURI":"/faq/deleteCmmFaq.do"},
            ...
            fileUtil = new FileUtil({
                ...
                "postService"     : "faqService.updateCmmFileAttchId"
            });
        ...
        function fn_save() {
            ...
            $('#qKey').val("faq.insertCmmFaq");

            var url = "<c:out value="/common/insert.do"/>";
            if($('#SAVE_MODE').val() == "U"){
                url = "<c:out value="/common/update.do"/>";

                $('#qKey').val("faq.updateCmmFaq");
            }

            $.comm.sendForm(url, "detailForm", fn_callback, "FAQ 저장");
        }
