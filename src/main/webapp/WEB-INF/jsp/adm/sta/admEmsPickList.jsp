<%--
    Class Name : admEmsPickList
    Description : EMS 픽업요청 현황
    ...
    <script>
        ...
        $(function () {
            ...
            headers = [
                ...
                {"HEAD_TEXT": "수취인국가코드", "WIDTH": "100", "FIELD_NAME": "COUNTRYCD"},
                {"HEAD_TEXT": "수취인국가명"  , "WIDTH": "100", "FIELD_NAME": "COUNTRYCD_NM"},
            ...
            $('#COUNTRYCD').on("keyup", function () {
                this.value = this.value.toUpperCase();
            });
        });

        function fn_search() {
            //if (!$.comm.isNull($('#BIZ_NO').val()) || !$.comm.isNull($('#COUNTRYCD').val())) {
        ...
        <form id="searchForm">
            <div class="search_frame">
                <ul class="search_sectionB">
                    ...
                    <li>
                        <label for="COUNTRYCD">수취인국가 코드</label>
                        <input id="COUNTRYCD" name="COUNTRYCD" type="text" style="width:100px"/>
                        <a href="#적출국 코드" class="btn_search" id="btnCountryCd"><img src="/images/btn/btn_search_box.png" alt=""></a>
                    </li>
                </ul>
