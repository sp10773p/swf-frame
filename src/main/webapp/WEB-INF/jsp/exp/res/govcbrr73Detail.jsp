...
<div class="inner-box">
    ...
    <div class="padding_box">
    	<div class="title_frame">
			...
			<p><a href="#" class="btnToggle_table">수출선별결과통보</a></p>
                ...
                <table style="table-layout:fixed;" >
                    ...
                    <colgroup>
                        ...
                        <tr>
	                        ...
	                        <td><span id="PERSON_CD"/></td>
	                        <td><label for="CUS_NM">접수 세관</label></td>
	                        <td><span id="CUS_NM"/></td>
	                    </tr>
	                    <tr>
	                        <td><label for="RESULT_NM">선별결과 구분</label></td>
	                        <td><span id="RESULT_NM" /></td>
	                        <td><label for="PERSON_NM">세관담당자 명</label></td>
	                        <td><span id="PERSON_NM"/></td>
	                        <td><label for="SEC_NM">접수 과</label> </td>
	                        <td><span id="SEC_NM"/></td>
	                    </tr>
	                    <tr>
	                        <td><label for="RCV_DTM">수출신고 수신일시</label></td>
	                        <td><span id="RCV_DTM" /></td>
	                        <td><label for="DPT_DTM">선별결과 통보일시</label></td>
	                        <td colspan="3"><span id="DPT_DTM" /></td>
	                    </tr>
	                    <tr>
	                        <td><label for="RESULT_TXT">서류제출 구분사항</label></td>
	                        <td colspan="5">
