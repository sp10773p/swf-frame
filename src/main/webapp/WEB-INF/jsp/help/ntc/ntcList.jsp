...
<head>
    ...
    <script>
        ...
        $(function () {
            ...
            // 로그인 화면의 공지사항에서 넘어온 경우
            if(!$.comm.isNull(parent.mfn_getVariable("SN"))){
				$('#SN').val(parent.mfn_getVariable("SN"));
				$('#F_MOD_DTM').val("");
				$('#T_MOD_DTM').val("");

                parent.mfn_getVariable("SN", null);
            }
