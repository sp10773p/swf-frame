...
public class FaqServiceImpl implements FaqService {
    ...
    public AjaxModel updateCmmFileAttchId(AjaxModel model) throws Exception {
        ...
        for(Map<String, Object> data : list) {
            ...
            commonDAO.update("faq.updateCmmFileAttchId", params);
        }
        return model;
    }
     ...
     */
    @Override
    public AjaxModel deleteCmmFaq(AjaxModel model) {
        ...
        for(Map<String, Object> param : dataList){
            commonDAO.delete("faq.deleteCmmFileDtl", param); // 파일 상세 삭제
            commonDAO.delete("faq.deleteCmmFileMst", param); // 파일 마스터 삭제
            commonDAO.delete("faq.deleteCmmFaq", param);     // FAQ 삭제
        }
